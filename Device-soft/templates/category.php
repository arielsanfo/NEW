...
<div class="container-fluid pt-5">
    ...
    <div class="row px-xl-5 pb-3">
        <?php 
                    ...
                    $select=$Product->get_product_category($id); 
        ...
        <div class="col-lg-3 col-md-6 col-6 col-sm-6 pb-1">
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                    <a href="<?= $router->generate('detail') ?>?id=<?= $selects->id_produits ?>"
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <?php if($selects->reduction > 0): ?>
                            <h6>$
                                <?= number_format($selects->prix-($selects->prix * $selects->reduction/100), 2,'.',',') ?>
                            </h6>
                ...
                <div class="card-footer d-flex justify-content-center bg-light border">
                    <a onclick="add_cart(<?= $selects->id_produits ?>)" class="btn btn-sm text-dark p-0"><i
                            class="fas fa-shopping-cart text-primary mr-1"></i>Ajouer au panier</a>
                </div>
            </div>
        </div>
        <?php endforeach ?>
